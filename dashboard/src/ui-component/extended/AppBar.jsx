        ...
        <Container>
          <Toolbar sx={{ py: 2.5, px: `0 !important` }}>
            ...
            <Stack direction="row" sx={{ gap: { xs: 1.5, md: 2.5 }, display: { xs: 'none', sm: 'flex' } }}>
              <Button color="inherit" component="a" href="http://localhost:5173" target="_blank">
                Store
              </Button>
              <Button color="inherit" component={RouterLink} to="/login">
                Dashboard
              </Button>
              <Button color="inherit" component={RouterLink} to="/products/list">
                Products
              </Button>
              <Button component={RouterLink} to="/orders/list" disableElevation variant="contained" color="secondary">
                Orders
              </Button>
            </Stack>
              ...
              <Drawer anchor="top" open={drawerToggle} onClose={drawerToggler(false)}>
                {drawerToggle && (
                  <Box sx={{ width: 'auto' }} role="presentation" onClick={drawerToggler(false)} onKeyDown={drawerToggler(false)}>
                    <List>
                      <Link sx={{ textDecoration: 'none' }} href="http://localhost:5173" target="_blank">
                      ...
                      <Link sx={{ textDecoration: 'none' }} href="/products/list">
                        <ListItemButton component="a">
                          <ListItemIcon>
                            <IconBook />
                          </ListItemIcon>
                      ...
                      <Link sx={{ textDecoration: 'none' }} href="/orders/list">
                        <ListItemButton component="a">
                          <ListItemIcon>
                            <IconCreditCard />
                          </ListItemIcon>
