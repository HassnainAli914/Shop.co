...
import { getProductById, updateProduct } from './productData';
...
export default function ProductEdit() {
    ...
    if (id) {
      ...
      if (product) {
        setFormData({
          ...
          offerPrice: product.offerPrice ? product.offerPrice.replace('$', '') : '',
  ...
  const validate = () => {
    ...
    if (!String(formData.salePrice).trim()) errs.salePrice = true;
  ...
  const handleSubmit = (e) => {
    ...
    const updated = {
      ...
      sku: formData.sku,
      salePrice: String(formData.salePrice).startsWith('$') ? formData.salePrice : `$${formData.salePrice}`,
      offerPrice: formData.offerPrice
        ? String(formData.offerPrice).startsWith('$')
          ? formData.offerPrice
          : `$${formData.offerPrice}`
        : `$${formData.salePrice}`,
    ...
    updateProduct(id || '1', updated);
    setSuccess(true);
    setTimeout(() => {
      navigate(`/products/details/${id || '1'}`);
    }, 1000);
  };
  ...
  return (
    <Box>
      ...
      <EcommerceBreadcrumbHeader title="Edit Product" current="Edit Product" />
      ...
      >
        ...
        {success && (
          <Alert severity="success" sx={{ mb: 3 }}>
            Product updated successfully! Redirecting to details...
          </Alert>
        )}
