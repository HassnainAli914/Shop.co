...
export default function Top_sell({
  ...
  return (
    <div className="w-full h-full mt-14 lg:mt-24 max-w-screen-xl mx-auto px-4">
      <div className="border-t border-gray-100 my-8" />
      <h1 className="text-3xl md:text-5xl font-extrabold text-center tracking-tight uppercase">
        {title}
      </h1>
